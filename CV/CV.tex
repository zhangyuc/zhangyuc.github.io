...
{Supervisor: Percy Liang and Moses Charikar}\vspace{3pt}\\
...
\textbf{2015}~~~~~~~~Baidu Scholarship (awards 8 PhD students every year worldwide).\\
...
\vspace{-5pt}
Proficient in Python, C/C++, C\#, Java, Scala; Capable of \textsc{Matlab}, \LaTeX, bash.
