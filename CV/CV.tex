...
\item I lead the design and implementation of a revolutionary dialogue engine that powers arbitrarily complex natural language understanding and seamless cross-turn, cross-domain dialogue state management (\href{https://zhuanlan.zhihu.com/p/245081650}{Learn about the design}).
\end{my_item}
\vspace{-5pt}
