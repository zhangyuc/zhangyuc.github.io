...
\vspace{-10pt}
\begin{my_item}
\item My team builds revolutionary dialogue technologies that understand complex natural language queries, and can drive multi-turn conversations to communicate, collaborate, and accomplish tasks.
...
\item I lead the core representation and modeling efforts for our dialogue system.
\end{my_item}
\vspace{-5pt}
{\bf Senior Research Scientist at Semantic Machines}\hfill\textbf{2018}\\
\vspace{-10pt}
\begin{my_item}
\item Semantic Machines is a team of world-class researchers and engineers working on innovative dialogue  technologies. The team consists of professors of Stanford, UC Berkeley, MIT, and engineers who have previously built the core AI assistant technology for Apple and Google.
