...
\item Our team builds the next-generation bot framework for Microsoft, enabling an unprecedented conversational AI experience where the user can speak naturally, contextually and collaboratively to a virtual assistant just like speaking to a human (\href{https://www.microsoft.com/en-us/research/project/semantic-machines}{Learn about the team}, \href{https://news.microsoft.com/videos/microsofts-semantic-machines-showcases-new-conversational-ai-technology/}{Demo})

\item I lead the design and the development of the core dialogue system. It is based on an innovative dataflow-synthesis framework that supports arbitrarily complex language understanding and seamless cross-turn, cross-domain state tracking (\href{https://zhuanlan.zhihu.com/p/245081650}{Learn about the design}).
