...
\item I lead the design and the development of the core dialogue system. It is an innovative program synthesis framework that supports arbitrarily complex language understanding and seamless cross-turn, cross-domain dialogue state tracking (\href{https://zhuanlan.zhihu.com/p/245081650}{Learn more about the design}).
