...
\vspace{-10pt}
\begin{my_item}
\item My team builds task-oriented dialogue systems that go beyond understanding commands, intents and slots. Our bot understands very complex natural language queries, and drives dynamic conversations of many turns to communicate, collaborate, and accomplish tasks.
\item Serving MS Office and 3rd-party parteners with AI assiatant and customer service bots (\href{https://v.youku.com/v_show/id_XNDE3MTExODQ0MA}{demo link}).
\item I lead the design/development of our dialogue system's core representation and modeling architecture.
\end{my_item}
\vspace{-5pt}
{\bf Senior Research Scientist at Semantic Machines}\hfill\textbf{2018}\\
\vspace{-10pt}
\begin{my_item}
\item We are a start-up company focusing on conversational AI technologies, made of world-class researchers and engineers, including professors of Stanford, UC Berkeley, MIT, as well as core contributors to the AI assistant technology for Apple and Google.
\item Acquired by Microsoft on June, 2018.
\end{my_item}
\vspace{-5pt}
...
Below is a list of my research projects and their patent/publication references:
