...
\vspace{-5pt}
{\bf Principal Researcher, Microsoft}\hfill\textbf{2018 - Now}
\begin{my_item}
\item Build the next-generation bot framework for Microsoft,  enabling a revolutionary conversational AI experience where the user can speak naturally, contextually and collaboratively to a virtual assistant just like speaking to a human. Our technology ships to a wide range of Microsoft products (\href{https://v.youku.com/v_show/id_XNDc0Nzg5MDc2MA}{Demo in Satya Nadella's keynote}; \href{https://www.microsoft.com/en-us/research/project/semantic-machines}{Learn about the team})

\item I lead the design and implementation of our core dialogue engine that powers arbitrarily complex natural language understanding and seamless cross-turn, cross-domain dialogue state management (\href{https://zhuanlan.zhihu.com/p/245081650}{Learn about the design}).

\item I also lead the internationalization projects,  including multilingual data collection,  modeling
and generation for all markets outside of United States.
...
\item Personalized recommendation system [\ref{taxonomy-wsdm14}].
