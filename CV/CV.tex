...
\begin{my_item}
\item Build the next-generation bot framework for Microsoft, enabling an unprecedented conversational AI experience where the user can speak naturally, contextually and collaboratively to a virtual assistant just like speaking to a human. Our technology ships to a wide range of Microsoft products (\href{https://v.youku.com/v_show/id_XNDc0Nzg5MDc2MA}{Watch demo}; \href{https://www.microsoft.com/en-us/research/project/semantic-machines}{Learn about the team})

\item I lead the design and development of the core dialogue engine -- an innovative program synthesis framework that supports complex language understanding and seamless cross-turn, cross-domain dialogue state tracking (\href{https://zhuanlan.zhihu.com/p/245081650}{Learn about the design}).
\end{my_item}
\vspace{-5pt}
